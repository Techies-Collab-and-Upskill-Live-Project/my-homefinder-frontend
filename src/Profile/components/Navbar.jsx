...
const Navbar = () =>{
    ...
    return(
        <nav className="py-3  shadow-lg gap-x fixed top-0 z-50 w-full bg-gray-50">
            <div className="flex justify-around items-center">
                ...
                <ul className="hidden md:flex gap-6 text-green-950 cursor-pointer">
                    ...
                    <li className="text-gray-600 hover:text-gray-700 font-medium">Manage Properties</li>
                </ul>

                <div className="hidden md:flex gap-x-2 justify-center items-center">
                    <img src={MessageIcon} alt="" className="w-5" />
                    <img src={UserImage} alt="" className="w-7 h-7" />
                    <p className="text-sm">Favy Lucy</p>
                    <svg width="14" height="9" viewBox="0 0 15 10" fill="none" xmlns="http://www.w3.org/2000/svg">
