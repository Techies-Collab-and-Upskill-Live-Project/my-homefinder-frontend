  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-6 py-8 mt-32 font-sans leading-normal border border-gray-300 rounded-xl shadow-lg space-y-8">
        ...
        <div className="flex flex-col border border-gray-300 rounded-xl shadow-lg p-6 space-y-0.5 mt-4">
          {" "}
          {/* profile-contact with individual styles */}
        ...
        <div className="flex flex-col border border-gray-300 rounded-xl shadow-lg p-6 space-y-3 mt-4">
          ...
          <p className="text-sm text-gray-700 break-words">
            Figma ipsum component variant main layer subtract opacity union
            export boolean asset clip draft. Outline bold vector storke blur
            component auto scale component project. shadow component main
            section font resizing object project project bold resizing.
          </p>
        </div>
