...
const AllMessages = ({ onSelect }) => {
  ...
  return (
    <aside className="w-[400px] fixed left-0 top-0 h-screen border-r border-green-300 bg-white overflow-y-auto">
      <h2 className="text-xl font-semibold text-green-800 p-4 border-b border-green-300">
        Messages
      </h2>
      <div>
